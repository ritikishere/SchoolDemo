    ...
    <div className="font-poppins bg-gradient-to-br from-amber-50 to-rose-100 min-h-screen flex flex-col">
      ...
      <div className="p-6 text-center mt-10">
        ...
        <div className="flex flex-col justify-center items-center gap-6 mt-4">
          ...
          <Link 
            to="/about" 
            className="px-6 py-2 bg-rose-600 text-white rounded-lg text-lg hover:bg-rose-700 transition"
          >
            View More
          </Link>
        </div>  
      ...
      {/* 👇 Cards Section */}
      <div className="max-w-6xl mx-auto px-4 mt-16 mb-32 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <Link
          to="/admission/apply"
          className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-xl"
        >
          <FaFileAlt className="text-5xl text-rose-500 mb-4" />
        ...
        <Link
          ...
          className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-xl"
        >
          <FaPoll className="text-5xl text-rose-500 mb-4" />
        ...
        <Link
          ...
          className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-xl"
        >
          <FaMoneyCheckAlt className="text-5xl text-rose-500 mb-4" />
        ...
        <Link
          ...
          className="flex flex-col items-center bg-white rounded-2xl shadow-lg p-8 cursor-pointer transform transition-transform duration-300 hover:scale-105 hover:shadow-xl"
        >
          <FaImages className="text-5xl text-rose-500 mb-4" />
